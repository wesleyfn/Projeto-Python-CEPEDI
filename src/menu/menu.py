...
def cadastro_pessoa():
    ...
    dia, mes, ano = input(" > Digite a data de nascimento [dd/mm/aa]: ").split("/")
    ...
    while loop_condition:
        ...
        match opcao:
            case 1:
                ...
                dia, mes, ano = input(" > Digite a data de engresso dd/mm/aa: ").split("/")
                data_engresso = datetime.datetime.strptime(f"{dia} {mes} {ano}", "%d %m %Y")

                especialidade = input(" > Digite a especialidade: ")
                
                especialista = Especialista(nome, cpf, sexo, data_nascimento, endereco, telefone, cro, especialidade, data_engresso)
            case 2:
                nome, cpf, sexo, data_nascimento, endereco, telefone = cadastro_pessoa()
